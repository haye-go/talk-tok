      ...
      <div className="grid gap-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[var(--c-muted)]">Flag obviously abusive content before publication</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[var(--c-muted)]">Check Fight Me and roast-mode replies for safety</p>
              </div>
              <Switch checked={true} onChange={() => {}} label="" />
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-[var(--c-muted)]">Track typing duration, paste events, idle gaps</p>
              </div>
              <Switch checked={true} onChange={() => {}} label="" />
            </div>
            <Input label="Disclosure text" defaultValue="This session records composition timing to help you reflect on your writing process." />
          </div>
        </Card>
        ...
        <Card title="AI Budget">
          ...
          <p className="mt-2 text-xs text-[var(--c-muted)]">
            When soft warning is hit, instructor sees an alert. At hard ceiling, non-essential AI features pause.
          </p>
        </Card>
      </div>
    </AdminShell>
