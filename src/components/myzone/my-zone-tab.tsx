import { Sword, Timer } from "@phosphor-icons/react";
...
export function MyZoneTab() {
  ...
  return (
    <div className="space-y-3">
      ...
      >
        <p className="text-xs leading-relaxed text-[var(--c-body)]">&ldquo;{sub.text}&rdquo;</p>
      ...
      >
        <div className="flex items-center justify-between">
          <span className="font-display text-xs font-semibold text-[var(--c-sig-coral)]">
            <Sword size={12} className="mr-0.5 inline" /> Fight Me vs AI
          </span>
      ...
      >
        ...
        <p className="mt-0.5 text-[10px] text-[var(--c-muted)]">
          Suggested: Cost &amp; Access → <span className="text-[var(--c-success)]">Approved ✓</span>
        </p>
      </div>
    </div>
  );
